...
The `pyproject.toml` and `setup.cfg` already contain the proper configuration for these tools. If you are working in a moren IDE (such a VSCode), which integrates these tools, the options will be picked up.
