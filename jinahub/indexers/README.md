...
In the above case, the Storage could be the [PostgreSQL](storage/PostgreSQLStorage)-based Storage, while the Query Flow could be based on [NumpyPostgresSearcher](searcher/compound/FaissPostgresSearcher).
